...
describe Dyph3::Differ do
  ...
  describe "both moves and inserts" do
    it "should handle when base and left match" do
      ...
      result = Dyph3::Differ.merge_text(left, base, right, split_function: identity , join_function: identity)
  ...
  describe "test split" do
    ...
    let(:merged_array) do
       Dyph3::Differ.merge_text(left, base, right, split_function: identity, join_function: identity )
    end
