...
describe Dyph3::Outcome::Resolved do
  describe "simple conflict" do
    let(:outcome) { Dyph3::Outcome::Resolved.new([:result]) }
    let(:other_outcome) { Dyph3::Outcome::Resolved.new([:other_result]) }
   ...
   describe "#conflicted?" do
    ...
    describe "#==" do
      ...
      describe "similar" do
        let(:other_outcome) { Dyph3::Outcome::Resolved.new([:result]) }
    ...
    describe "#apply" do
      ...
      let(:result) { Dyph3::Outcome::Resolved.new(:result) }
